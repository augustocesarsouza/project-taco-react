...
const SvgArrow = ({rotate, width = "20px", fill = "#959595"}: SvgArrowProps) => {
    // useEffect(() => {
    //     console.log(rotate);
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width={width} fill={fill} style={{ transform: `rotate(${rotate})` }}>
